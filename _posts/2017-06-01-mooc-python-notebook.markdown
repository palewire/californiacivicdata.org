...
The California Civic Data Coalition's open-source course ["First Python Notebook."](http://www.firstpythonnotebook.org) is expanding to become a massive open online course (often known as a "MOOC") hosted by the Knight Center for Journalism in the Americas at the University of Texas in Austin.
