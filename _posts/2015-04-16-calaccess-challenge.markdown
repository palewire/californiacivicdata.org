...
Carefully connecting dots has shown how creative accounting can conceal [organized efforts](http://www.latimes.com/local/politics/la-me-ff-pol-1101-proposition47-20141101-story.html#page=1) behind high-stakes ballot measures and how powerful legislative appointments [are made](http://cironline.org/reports/california-speaker-gives-assemblys-juiciest-jobs-biggest-fundraisers-4501). But few comprehensive indicators exist for routinely mapping the political landscape to visualize its shape.
