...
If nothing else, [watch James Bennett's excellent 2008 talk](https://www.youtube.com/watch?v=A-S0tqpPga4) on designing reusable applications and ask yourself, every time you start a new project, how you could package it for future reuse and open-source collaboration. It's a simple but powerful approach that has multiplied the reach and reuse of open-source software and, we hope, can do the same for open data.