...
A new release of [our software](http://django-calaccess-campaign-browser.californiacivicdata.org/en/latest/) for parsing and analyzing California's campaign finance database now features crucial data withheld by the state.
