...
We're opening it to celebrate the conclusion of our massive open online course (MOOC) titled ["Python for Data Journalists."](http://journalismcourses.org/PDJ0517.html) Over the past two months, our free ["First Python Notebook"](http://www.firstpythonnotebook.org) lesson plan has served as the foundation for instructing more than 2,800 students around the world on data analysis with the Python programming language.  
