...
<img style="-webkit-user-select: none; cursor: zoom-in;" src="/img/jasmine_and_ben.jpg" width="100%">
...
* We've added a setting to enforcing archiving of earlier versions of the raw data files.
...
We could not have succeed in this gargantuan effort were it not for our ever-helpful contributors who volunteered their time and energy to our cause.
...
Brick-by-brick and database column-by-database column, these commits by the code rushers added up to a huge boost in our documenting effort. Also, a special thanks to [Anthony Pesce](https://github.com/anthonyjpesce) of the Los Angeles Times Data Desk for laying the groundwork for our new archving feature.
